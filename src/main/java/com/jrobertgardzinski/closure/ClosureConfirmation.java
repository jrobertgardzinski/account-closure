 ...
 */
public record ClosureConfirmation(String sagaId, String email, int reserved) {
     ...
     * id falls back to matching by e-mail. So a purge command that arrived without the field (an
    ...
    public Map<String, Object> fields() {
        ...
        message.put(ClosureMessages.Field.EMAIL, email);
